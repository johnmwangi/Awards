...
def directory(request):
    ...
    caraousel=Project.objects.filter(id=8)

    return render(request,'directory.html',{"winners":winners,"profile":profile,"directory":directory,"caraousel":caraousel,"date":date})
